...
function Register() {
  ...
  const handleEmailSubmit = async () => {
    ...
    try {
      const response = await axiosInstance.post("/api/v1/auth/register", { email });
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-400 focus:border-blue-400 outline-none transition-all backdrop-blur-sm"
                    style={{
